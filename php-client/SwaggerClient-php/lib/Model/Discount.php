...
class Discount implements ArrayAccess
{
    ...
    const TYPE_FIXED_AMOUNT__DEFAULT = 'fixed_amount (default)';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_FIXED_AMOUNT__DEFAULT,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("percentage", "fixed_amount (default)");
    ...
    /**
     * Sets description
     * @param string $description Reason for the discount
     * @return $this
     */
    ...
    /**
     * Sets value
     * @param string $value The value of the discount. If the type of the discount is `fixed_amount`, then this is a fixed dollar amount, if the type is `percentage`, then this is the percentage.
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type The type of the discount. Can be one of - `percentage` or `fixed_amount`. `Fixed_amount` is default value.
     * @return $this
     */
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'percentage', 'fixed_amount (default)'");
        }
    ...
    /**
     * Sets amount
     * @param string $amount The applied amount of the discount.
     * @return $this
     */
