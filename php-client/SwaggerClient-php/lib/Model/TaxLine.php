 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TaxLine implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'tax_line';
    ...
    /**
     * Sets rate
     * @param string $rate The rate of tax to be applied.
     * @return $this
     */
    ...
    /**
     * Sets price
     * @param string $price The amount of tax to be charged.
     * @return $this
     */
