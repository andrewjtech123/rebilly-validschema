...
class DefaultApi
{
    ...
    /**
     * Operation adminDraftOrdersidCheckoutJsonPost
     *
     * Create or retrieve existing checkout
     *
     * @param int $id2  (required)
     * @param string $id id of the draft order (optional)
     * @return \Swagger\Client\Model\Checkout
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function adminDraftOrdersidCheckoutJsonPost($id2, $id = null)
    {
        list($response) = $this->adminDraftOrdersidCheckoutJsonPostWithHttpInfo($id2, $id);
        return $response;
    }

    /**
     * Operation adminDraftOrdersidCheckoutJsonPostWithHttpInfo
     *
     * Create or retrieve existing checkout
     *
     * @param int $id2  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function adminDraftOrdersidCheckoutJsonPostWithHttpInfo($id2, $id = null)
    {
        // verify the required parameter 'id2' is set
        if ($id2 === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id2 when calling adminDraftOrdersidCheckoutJsonPost');
        }
        // parse inputs
        $resourcePath = "/admin/draft_orders/#{id}/checkout.json";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Checkout', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Checkout', $e->getResponseHeaders());
