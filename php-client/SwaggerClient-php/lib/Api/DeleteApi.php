...
class DeleteApi
{
    ...
    /**
     * Operation adminDraftOrdersidJsonDelete
     *
     * 
     *
     ...
     */
    public function adminDraftOrdersidJsonDelete($id)
    {
        list($response) = $this->adminDraftOrdersidJsonDeleteWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation adminDraftOrdersidJsonDeleteWithHttpInfo
     *
     * 
     *
     * @param int $id draft order id (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function adminDraftOrdersidJsonDeleteWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling adminDraftOrdersidJsonDelete');
        }
        // parse inputs
