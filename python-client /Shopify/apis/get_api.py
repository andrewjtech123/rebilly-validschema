...
class GetApi(object):
    ...
    def admin_draft_orders_count_json_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_orders_count_json_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.admin_draft_orders_count_json_get_with_http_info(**kwargs)
        else:
            (data) = self.admin_draft_orders_count_json_get_with_http_info(**kwargs)
            return data

    def admin_draft_orders_count_json_get_with_http_info(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_orders_count_json_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method admin_draft_orders_count_json_get" % key
                )
            params[key] = val
        del params['kwargs']

        resource_path = '/admin/draft_orders/count.json'.replace('{format}', 'json')
        path_params = {}
    ...
    def admin_draft_orders_json_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_orders_json_get(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.admin_draft_orders_json_get_with_http_info(**kwargs)
        else:
            (data) = self.admin_draft_orders_json_get_with_http_info(**kwargs)
            return data

    def admin_draft_orders_json_get_with_http_info(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_orders_json_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method admin_draft_orders_json_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def admin_draft_ordersid_json_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_ordersid_json_get(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.admin_draft_ordersid_json_get_with_http_info(id, **kwargs)
        else:
            (data) = self.admin_draft_ordersid_json_get_with_http_info(id, **kwargs)
            return data

    def admin_draft_ordersid_json_get_with_http_info(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_ordersid_json_get_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method admin_draft_ordersid_json_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `admin_draft_ordersid_json_get`")
