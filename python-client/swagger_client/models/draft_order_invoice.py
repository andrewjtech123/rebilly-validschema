...
class DraftOrderInvoice(object):
    """
    ...
    def __init__(self, to=None, _from=None, bcc=None, subject=None, custom_message=None):
        """
        DraftOrderInvoice - a model defined in Swagger
    ...
    def to(self):
        """
        Gets the to of this DraftOrderInvoice.
        ...
        :return: The to of this DraftOrderInvoice.
        :rtype: str
        """
        return self._to
    ...
    def to(self, to):
        """
        Sets the to of this DraftOrderInvoice.
        Email associated with the `draft_order_invoice`.  If not specified, the email associated with the draft order, or the customer's email will be used instead.  If no email address is specified an error is raised.

        :param to: The to of this DraftOrderInvoice.
        :type: str
        """
    ...
    def _from(self):
        """
        Gets the _from of this DraftOrderInvoice.
        ...
        :return: The _from of this DraftOrderInvoice.
        :rtype: str
        """
        return self.__from
    ...
    def _from(self, _from):
        """
        Sets the _from of this DraftOrderInvoice.
        The email address that the email will appear to be sent from. This defaults to the shop's customer email, and if none exists, simply the shop's account email. When provided, this email address must correspond to the email address of one of the staff accounts.

        :param _from: The _from of this DraftOrderInvoice.
        :type: str
        """
    ...
    def bcc(self, bcc):
        """
        Sets the bcc of this DraftOrderInvoice.
        Optional array of email addresses to bcc. These must correspond to valid staff account email addresses.

        :param bcc: The bcc of this DraftOrderInvoice.
        :type: str
        """
    ...
    def subject(self):
        """
        Gets the subject of this DraftOrderInvoice.
        ...
        :return: The subject of this DraftOrderInvoice.
        :rtype: str
        """
    ...
    def subject(self, subject):
        """
        Sets the subject of this DraftOrderInvoice.
        The subject of the email that will be sent. When not provided, defaults to the Draft Order Invoice template's subject, as specified in the shop's Notification settings.

        :param subject: The subject of this DraftOrderInvoice.
        :type: str
        """
    ...
    def custom_message(self):
        """
        Gets the custom_message of this DraftOrderInvoice.
        An optional custom message inserted in the email's body.

        :return: The custom_message of this DraftOrderInvoice.
        :rtype: str
        """
    ...
    def custom_message(self, custom_message):
        """
        Sets the custom_message of this DraftOrderInvoice.
        An optional custom message inserted in the email's body.

        :param custom_message: The custom_message of this DraftOrderInvoice.
        :type: str
        """
