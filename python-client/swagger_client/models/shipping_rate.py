...
class ShippingRate(object):
    ...
    """
    def __init__(self, handle=None, title=None, phone_required=None, price=None):
        """
        ShippingRate - a model defined in Swagger
        ...
        self._handle = handle
        self._title = title
        self._phone_required = phone_required
        self._price = price

    @property
    def handle(self):
        """
        Gets the handle of this ShippingRate.
        handle of the shipping rate

        :return: The handle of this ShippingRate.
        :rtype: str
        """
        return self._handle
    ...
    def handle(self, handle):
        """
        Sets the handle of this ShippingRate.
        handle of the shipping rate

        :param handle: The handle of this ShippingRate.
        :type: str
        """
    ...
    def title(self):
        """
        Gets the title of this ShippingRate.
        The shipping method name.

        :return: The title of this ShippingRate.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """
        Sets the title of this ShippingRate.
        The shipping method name.

        :param title: The title of this ShippingRate.
        :type: str
        """
    ...
    def phone_required(self):
        """
        Gets the phone_required of this ShippingRate.
        Indicates if a phone number is required, when `shipping_rate` is applied to a draft order.  Possible values - `true` or `false`

        :return: The phone_required of this ShippingRate.
        :rtype: bool
        """
        return self._phone_required

    @phone_required.setter
    def phone_required(self, phone_required):
        """
        Sets the phone_required of this ShippingRate.
        Indicates if a phone number is required, when `shipping_rate` is applied to a draft order.  Possible values - `true` or `false`

        :param phone_required: The phone_required of this ShippingRate.
        :type: bool
        """
    ...
    def price(self):
        """
        Gets the price of this ShippingRate.
        The price of the shipping rate.

        :return: The price of this ShippingRate.
        :rtype: str
        """
        return self._price
    ...
    def price(self, price):
        """
        Sets the price of this ShippingRate.
        The price of the shipping rate.

        :param price: The price of this ShippingRate.
        :type: str
        """
