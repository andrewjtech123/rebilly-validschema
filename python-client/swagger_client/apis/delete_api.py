...
class DeleteApi(object):
    ...
    def admin_draft_ordersid_json_delete(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_ordersid_json_delete(id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.admin_draft_ordersid_json_delete_with_http_info(id, **kwargs)
        else:
            (data) = self.admin_draft_ordersid_json_delete_with_http_info(id, **kwargs)
            return data

    def admin_draft_ordersid_json_delete_with_http_info(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_draft_ordersid_json_delete_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method admin_draft_ordersid_json_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `admin_draft_ordersid_json_delete`")
