...
# Unit tests for SwaggerClient::CreateApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateApi.new
  end
  ...
  describe 'test an instance of CreateApi' do
    it 'should create an instact of CreateApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateApi)
    end
  end
