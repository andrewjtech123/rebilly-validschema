...
# Unit tests for SwaggerClient::ShippingRate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingRate' do
  before do
    # run before each test
    @instance = SwaggerClient::ShippingRate.new
  end
  ...
  describe 'test an instance of ShippingRate' do
    it 'should create an instact of ShippingRate' do
      expect(@instance).to be_instance_of(SwaggerClient::ShippingRate)
    end
  end
  ...
  describe 'test attribute "phone_required"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
