  ...
  class DeleteApi
    ...
    def admin_draft_ordersid_json_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DeleteApi.admin_draft_ordersid_json_delete ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling DeleteApi.admin_draft_ordersid_json_delete" if id.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DeleteApi#admin_draft_ordersid_json_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
