  ...
  class CreateApi
    ...
    def admin_draft_orders_json_post_with_http_info(draftorder, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreateApi.admin_draft_orders_json_post ..."
      end
      # verify the required parameter 'draftorder' is set
      fail ArgumentError, "Missing the required parameter 'draftorder' when calling CreateApi.admin_draft_orders_json_post" if draftorder.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreateApi#admin_draft_orders_json_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def admin_draft_ordersid_send_invoice_json_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CreateApi.admin_draft_ordersid_send_invoice_json_post ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CreateApi.admin_draft_ordersid_send_invoice_json_post" if id.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreateApi#admin_draft_ordersid_send_invoice_json_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
