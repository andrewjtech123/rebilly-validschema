...
module SwaggerClient
  class UpdateApi
    ...
    # @return [DraftOrder]
    def admin_draft_ordersid_complete_json_put(id, opts = {})
      data, _status_code, _headers = admin_draft_ordersid_complete_json_put_with_http_info(id, opts)
      return data
    end
    ...
    def admin_draft_ordersid_complete_json_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UpdateApi.admin_draft_ordersid_complete_json_put ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UpdateApi.admin_draft_ordersid_complete_json_put" if id.nil?
      # resource path
      local_var_path = "/admin/draft_orders/#{id}/complete.json".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UpdateApi#admin_draft_ordersid_complete_json_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def admin_draft_ordersid_json_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UpdateApi.admin_draft_ordersid_json_put ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UpdateApi.admin_draft_ordersid_json_put" if id.nil?
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'DraftOrder')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UpdateApi#admin_draft_ordersid_json_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
