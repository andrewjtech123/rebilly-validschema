...
module SwaggerClient
  ...
  class ShippingRate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'phone_required')
        self.phone_required = attributes[:'phone_required']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          handle == o.handle &&
          title == o.title &&
          phone_required == o.phone_required &&
          price == o.price
    end
    ...
    def hash
      [handle, title, phone_required, price].hash
    end
