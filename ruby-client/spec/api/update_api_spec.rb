...
# Unit tests for SwaggerClient::UpdateApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateApi.new
  end
  ...
  describe 'test an instance of UpdateApi' do
    it 'should create an instact of UpdateApi' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateApi)
    end
  end
