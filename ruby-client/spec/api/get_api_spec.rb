...
# Unit tests for SwaggerClient::GetApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetApi' do
  before do
    # run before each test
    @instance = SwaggerClient::GetApi.new
  end
  ...
  describe 'test an instance of GetApi' do
    it 'should create an instact of GetApi' do
      expect(@instance).to be_instance_of(SwaggerClient::GetApi)
    end
  end
