...
# Unit tests for SwaggerClient::DeleteApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteApi' do
  before do
    # run before each test
    @instance = SwaggerClient::DeleteApi.new
  end
  ...
  describe 'test an instance of DeleteApi' do
    it 'should create an instact of DeleteApi' do
      expect(@instance).to be_instance_of(SwaggerClient::DeleteApi)
    end
  end
