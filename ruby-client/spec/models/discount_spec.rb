...
# Unit tests for SwaggerClient::Discount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Discount' do
  before do
    # run before each test
    @instance = SwaggerClient::Discount.new
  end
  ...
  describe 'test an instance of Discount' do
    it 'should create an instact of Discount' do
      expect(@instance).to be_instance_of(SwaggerClient::Discount)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["percentage", "fixed_amount (default)"])
