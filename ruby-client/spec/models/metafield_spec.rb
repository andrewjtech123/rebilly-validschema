...
# Unit tests for SwaggerClient::Metafield
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Metafield' do
  before do
    # run before each test
    @instance = SwaggerClient::Metafield.new
  end
  ...
  describe 'test an instance of Metafield' do
    it 'should create an instact of Metafield' do
      expect(@instance).to be_instance_of(SwaggerClient::Metafield)
    end
  end
