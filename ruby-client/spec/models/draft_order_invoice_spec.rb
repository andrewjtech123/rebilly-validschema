...
# Unit tests for SwaggerClient::DraftOrderInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DraftOrderInvoice' do
  before do
    # run before each test
    @instance = SwaggerClient::DraftOrderInvoice.new
  end
  ...
  describe 'test an instance of DraftOrderInvoice' do
    it 'should create an instact of DraftOrderInvoice' do
      expect(@instance).to be_instance_of(SwaggerClient::DraftOrderInvoice)
    end
  end
