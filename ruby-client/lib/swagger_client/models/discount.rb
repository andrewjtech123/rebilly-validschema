...
module SwaggerClient
  ...
  class Discount
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["percentage", "fixed_amount (default)"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["percentage", "fixed_amount (default)"])
    ...
    def hash
      [description, value, type, amount].hash
    end
